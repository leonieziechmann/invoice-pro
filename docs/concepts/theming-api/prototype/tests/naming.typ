// Q7 vocabulary (rename-map.tsv + lead rulings): the new names resolve, the old
// ones are gone. Pure API asserts; compile-fail probes live in scripts/checks-naming.sh.
#import "/src/lib.typ": *
