// Frame view additions (gap 7), arrange/area extensions (gap 9) and page-number
// (from: auto, ctx-first format). Compiled under strict (run-all).
...
#show: invoice.with(theme: th, locale: test-locale, ..party, date: datetime(
  year: 2026,
  month: 9,
  day: 1,
))
