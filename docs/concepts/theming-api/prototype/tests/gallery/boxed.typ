// Gallery: `boxed` - an electrician's invoice to a private customer (Handwerk), with
// a site address, a service period, a down payment and the § 35a EStG labour note.
// German locale; layout: auto (a German sender: DIN 5008 A); --input layout=<name>
// swaps the page master, --input zugferd=1 adds the e-invoice (--pdf-standard a-3b).
#import "/src/lib.typ": *
