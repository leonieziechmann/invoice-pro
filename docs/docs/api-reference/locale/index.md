...
| `locale.custom.payment(..)`      | `text`, `text-due`, `deadline-date`, `deadline-days`, `deadline-soon`, `text-credit`, `deadline-soon-credit`                                               | Text and deadline phrasing for the payment goal.         |
