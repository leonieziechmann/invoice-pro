...
| `locale.custom.payment-means(..)` | `method`, `transfer`, `direct-debit`, `sepa-direct-debit`, `card`, `credit-card`, `debit-card`, `cash`, `cheque`, `online`, `mandate`, `creditor-id`, `debtor-iban`, `card-number`, `card-holder`, `paid`, `paid-due` | Texts of `direct-debit`, `card-payment` and `paid`.      |
| `locale.custom.payment(..)`       | `text`, `text-due`, `text-direct-debit`, `text-direct-debit-due`, `text-card`, `text-card-due`, `cash-discount`, `deadline-date`, `deadline-days`, `deadline-soon`                                                    | Text and deadline phrasing for the payment goal.         |
