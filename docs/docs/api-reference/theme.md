...
| Key                                         | Description                                                                                                                                                                                                                                          |
| :------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `view.sender.name`                          | The account holder: the `name` of `bank-details`, else the name of the `payee`, else the sender name on one line (the recipient's on a credit note or a self-billed invoice).                                                                        |
