...
/// entry names (`every`, `factur-x`, `xrechnung`) or codes of the entry's
/// own (`newer`, the codes only the newest version of the EN 16931 code list
/// has; `withdrawn`, the codes the newest version has withdrawn), as a
/// string of codes like a list of `lists`.
///
/// -> dictionary
#let validator = {
  let out = (:)
