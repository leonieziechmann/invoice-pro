// Gallery: `corporate` - a drive-technology manufacturer invoicing conveyor
// drives, retrofit work and spare parts to a logistics holding (purchase order,
// delivery note, framework contract, volume rebate). English locale, German
// sender: layout: auto picks a4-sidebar; `layout: <name>` swaps the page master.
#import "/src/lib.typ": *
