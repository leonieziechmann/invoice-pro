...
// scripts/checks-presets.sh and checks-presets-business.sh): elegant, prestige
// and bold on their default layout, 14..22 items, with and without a closing
...
#widow-sweep(("elegant", "prestige", "bold").map(p => (p, "auto")))
