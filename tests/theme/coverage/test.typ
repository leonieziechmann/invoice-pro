// Helper/schema coverage (prototype tests/coverage.typ): every schema key has a
// helper parameter and the other way round, the block DSL, chaining, and the
...
#import "/tests/theme/looks.typ": minimal-look
