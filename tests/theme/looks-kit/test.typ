// Looks kit (prototype tests/looks-kit.typ): layout by region for bold and
// compact, the kit helpers (payable-label, split-seller-ids, fit-size) and the
// bold disc contrast for dark, very dark and light seeds.
#import "/src/lib.typ": *
